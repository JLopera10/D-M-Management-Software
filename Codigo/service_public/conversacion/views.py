"""
US-04: mismo endpoint de Gemini expuesto en service_public (p. ej. puerto 8003).
El historial lo envía el cliente; la clave puede estar en service_public/.env o en service_chatbot/.env.
"""
